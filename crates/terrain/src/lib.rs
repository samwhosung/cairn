...
pub use mesh::{
    ALPHA_MAP_SIZE, CHUNK_SIZE, ChunkMesh, Doodad, LAYER_REPEATS_PER_CHUNK, SHADOW_MAP_SIZE,
    TILE_SIZE, TileMesh, VERTICES, WmoInstance, adt_to_tile_mesh, cell_vertices, is_hole,
};
pub use query::{
